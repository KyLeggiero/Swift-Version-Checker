...
#if swift(>=5.1) && !swift(>=5.1.1)
    languageVersion = "5.1"
#elseif swift(>=5.0)
    languageVersion = "5.0"
#elseif swift(>=4.2)
    languageVersion = "4.2"
#elseif swift(>=4.1.2) && !swift(>=4.1.3)
    languageVersion = "4.1.2"
#elseif swift(>=4.1.1)
    languageVersion = "4.1.1"
#elseif swift(>=4.1.0)
    languageVersion = "4.1.0"
#elseif swift(>=4.0.3) && !swift(>=4.0.4)
...
#elseif swift(>=4.0)
    languageVersion = "4.0"
#elseif swift(>=3.4) && !swift(>=3.4.1)
    languageVersion = "3.4"
#elseif swift(>=3.3) && !swift(>=3.3.1)
    languageVersion = "3.3"
#elseif swift(>=3.2) && !swift(>=3.2.1)
    languageVersion = "3.2"
#elseif swift(>=3.1.1) && !swift(>=3.1.2)
